...
## 私について
- 現在19歳です。
- 医学部医学科に所属している日本の大学生です。
- Apple製品が好きで、全てのイベントを観ます。
- `Swift`でのコードを学んでおり、以下のプロジェクトは最初のプロジェクトの一つです。
- 最近、ネットワークに関して興味を持っており、Raspberry Pi 5でDockerを使っています。様々なオープンソースソフトウェアを試しています。（e.g. AdGuard, n8n, NetData, uptime-kuma, Portainer...）
